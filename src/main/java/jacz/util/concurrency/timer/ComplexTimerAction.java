 ...
 */
public interface ComplexTimerAction<T> {

    /**
     * This method is invoked by a timer when its specified delay concludes
     *
     * @param timer the timer that invokes this action
     * @param event the event associated to this complex timer action
     ...
     */
    public Long wakeUp(Timer timer, T event);
}
