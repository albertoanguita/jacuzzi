 ...
 */
public class Range<T extends Number & Comparable<T>> implements RangeInterface<T>, Serializable {
...
//    @Override
//    public <Y extends RangeInterface<T>> Y buildInstance(T min, T max) {
//        //noinspection unchecked
//        return (Y) new Range<>(min, max, clazz);
//    }
     ...
     */
    public RangeComparison compareTo(RangeInterface<T> range) {
    ...
    public RangeList<T> subtract(Range<T> range) {
        ...
        switch (compareTo(range)) {
            ...
            case RIGHT_NO_CONTACT:
                ...
                break;
            case LEFT_OVERLAP:
                subtractList.add((Range<T>) buildInstance(min, previous(range.min)));
                break;
            case EQUALS:
            case INSIDE:
            ...
            case CONTAINS:
                subtractList.add((Range<T>) buildInstance(min, previous(range.min)));
                subtractList.add((Range<T>) buildInstance(next(range.max), max));
                break;
            case RIGHT_OVERLAP:
                subtractList.add((Range<T>) buildInstance(next(range.max), max));
                break;
