...
public class TimerOld {
    ...
    public TimerOld(long millis, TimerAction timerAction) {
        this(millis, timerAction, ThreadUtil.invokerName(1));
    }

    public TimerOld(long millis, TimerAction timerAction, String threadName) {
        this(millis, timerAction, true, threadName);
    }

    public TimerOld(long millis, TimerAction timerAction, boolean start, String threadName) {
